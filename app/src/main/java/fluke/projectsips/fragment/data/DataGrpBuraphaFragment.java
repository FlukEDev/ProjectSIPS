...
public class DataGrpBuraphaFragment extends Fragment {
    ...
    public DataGrpBuraphaFragment() {
        super();
    }

    public static DataGrpBuraphaFragment newInstance() {
        DataGrpBuraphaFragment fragment = new DataGrpBuraphaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_data_grp_burapha, container, false);
    ...
    private void tableView() {
        ...
        regionName.setText("กลุ่มเบญจบูรพาสุวรรณภูมิ");
