...
public class DataLfpLaborEdu extends Fragment {
    ...
    public DataLfpLaborEdu() {
        super();
    }

    public static DataLfpLaborEdu newInstance() {
        DataLfpLaborEdu fragment = new DataLfpLaborEdu();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_data_lfp_labor_edu, container, false);
    ...
    private void tableView() {
        ...
        String sumAll = String.valueOf(NumberFormat.getInstance().format(listSum.get(0) + listSum.get(1) + listSum.get(2) + listSum.get(3) +
                listSum.get(4) + listSum.get(8) + listSum.get(12) + listSum.get(13)));
        String sumMale = String.valueOf(NumberFormat.getInstance().format(listMale.get(0) + listMale.get(1) + listMale.get(2) + listMale.get(3) +
                listMale.get(4) + listMale.get(8) + listMale.get(12) + listMale.get(13)));
        String sumFemale = String.valueOf(NumberFormat.getInstance().format(listFemale.get(0) + listFemale.get(1) + listFemale.get(2) + listFemale.get(3) +
