...
public class DataLfpLaborCareer extends Fragment {
    ...
    public DataLfpLaborCareer() {
        super();
    }

    public static DataLfpLaborCareer newInstance() {
        DataLfpLaborCareer fragment = new DataLfpLaborCareer();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_data_lfp_labor_career, container, false);
